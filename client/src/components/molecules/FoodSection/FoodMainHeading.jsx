...
const FoodMainHeading = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center lg:mt-4">
      <Image src="/eduEmpowernment.jpg" width={100} height={100} className="w-full h-full"/>
      <div className="mt-8 lg:mt-0 lg:ml-4 flex flex-col">
        <span className="text-2xl font-bold">Growing Healthy Thriving Minds of the Next Generation</span>
        <span className="text-xl mt-4 font-bold">Our purpose</span>
        <span className="mt-4">
          Empower Food believes that every child has the ability to succeed
